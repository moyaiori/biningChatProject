	...
	public void eventRegist(){
		okB.addActionListener(new ActionListener()  {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(name.isEmpty()){
					JOptionPane.showMessageDialog(null, "이름 입력해라잉");
				}else if(id.isEmpty()){
					JOptionPane.showMessageDialog(null, "아이디 입력해");
				}else if(pw.isEmpty()){
					JOptionPane.showMessageDialog(null, "비번 입력해라잉");
				}else if(ssnT.isEmpty()){
					JOptionPane.showMessageDialog(null, "민번 앞자리 입력해라잉");
				}else if(ssnP.isEmpty()){
					JOptionPane.showMessageDialog(null, "민번 뒷자리 입력해라잉");
				}else if (email.isEmpty()){
					JOptionPane.showMessageDialog(null, "이메일 입력해라잉");
				}else if(phoneF.isEmpty()){
					JOptionPane.showMessageDialog(null, "전화 앞자리 입력해라잉");
				}else if(phoneB.isEmpty()){
					JOptionPane.showMessageDialog(null, "전화 뒷자리 입력해라잉");
				}else{
					joinSend();
