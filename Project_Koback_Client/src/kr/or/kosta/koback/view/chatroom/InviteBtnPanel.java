...
public class InviteBtnPanel extends JFrame {
	...
	public InviteBtnPanel(ChatUI chatUI, String userList, String roomNum, String roomTitle) {
		super("채팅방 초대");
		this.chatUI = chatUI;
...
//			chatUI.getChatClient().sendMessage(MessageType.C_INVITE_USER + MessageType.DELIMETER + chatUI.getUserLoginPanel().userId + MessageType.DELIMETER + roomNum_string + MessageType.DELIMETER + userJList.getSelectedValue());
			chatUI.getChatClient().sendMessage(MessageType.C_INVITE_USER + MessageType.DELIMETER + chatUI.getUserLoginPanel().userId + MessageType.DELIMETER + roomNum_string + MessageType.DELIMETER + userJList.getSelectedValue() + MessageType.DELIMETER + roomTitle);
		} catch (IOException e) {
