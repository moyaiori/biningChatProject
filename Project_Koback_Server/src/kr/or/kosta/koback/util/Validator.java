...
public class Validator {
	...
	public static void main(String[] args) {
		...
		System.out.println(Validator.validId("bangry313"));
		System.out.println(Validator.validEmail("kj3133k@aa.com"));
		System.out.println(Validator.validPhoneNumber("02-1234-1234"));
		System.out.println(Validator.validMobileNumber("010-1234-1234"));
		System.out.println(Validator.validSSN("880608-1041628"));
		System.out.println(Validator.validIP("255.255.34.56"));
		System.out.println(Validator.validFile("abc.png"));
	}
}
